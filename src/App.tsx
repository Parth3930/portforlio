...
export default function App() {
  const metaTags = {
    ...
    description:
      "Explore my portfolio to see my projects, skills, and experience as a developer.",
  };
  ...
  return (
    <Container maxWidth={false} disableGutters>
      ...
      >
        ...
        >
          I&apos;m Parth, a full stack developer skilled in front-end and
          back-end technologies. I create dynamic applications, focusing on
          seamless user experiences. In my spare time, I enjoy developing games
          with the Unreal Engine 5. Proficient in Python, Java, and other
          languages, with a strong interest in React, JavaScript, and clean
          code.
        </Typography>
        <Box
          sx={{
        ...
        >
          <Box sx={{ flexDirection: "row", display: "flex", gap: 2 }}>
            {socials.map(({ id, Icon, url }) => (
              <IconButton
                key={id}
                sx={{ color: "#A0A0A0", fontSize: { xs: 25, md: 35 } }}
