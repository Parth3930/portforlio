  ...
  const projects = [
    {
      title: "Yapster",
      description:
        "A Gen Z social media startup I'm currently working on. Building authentic connections and creative expression through innovative features and modern technology.",
    ...
    },
    {
      title: "Avina Money",
      description:
        "Explore and compare financial products from banks and financial institutions in one place. Get detailed information to make well-informed financial decisions. *Its an MVP*",
    ...
    },
    {
      title: "Realim",
      description:
        "A serverless, peer-to-peer AR collaboration platform. Enables private, invite-only AR boards where data is shared exclusively between participants. Features gesture-based AR interactions and fully serverless architecture.",
                  ...
                  {project.link ? (
                    <Button
                      ...
                      sx={{
                        ...
                        borderRadius: 2,
                        background:
                          "linear-gradient(45deg, #6CA2A6 30%, #8cc3c5 90%)",
                        fontWeight: 600,
                        color: "#121212",
